// Enhanced by AI on 2025-08-11T00:46:40.874Z
// Section: pricing
// Category: pricing
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="text-lg text-muted-foreground leading-relaxed mb-8">
            ...
            Transparent pricing with no hidden fees. Scale as your team grows.
          </p>
        ...
        <div className="text-center mt-16 max-w-2xl mx-auto">
          ...
          <p className="text-muted-foreground mb-6">
            We offer tailored solutions for teams with specific collaboration requirements. 
            Let's discuss how we can help your organization work better together.
          </p>
