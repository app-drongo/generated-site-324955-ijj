// Enhanced by AI on 2025-08-11T00:47:12.156Z
// Section: cta
// Category: cta
          ...
          <CardContent className="relative p-12 lg:p-16">
            <div className="text-center max-w-4xl mx-auto">
              ...
              <p className="text-lg sm:text-xl text-muted-foreground max-w-2xl mx-auto mb-12 leading-relaxed">
                ...
                Experience seamless teamwork with our intuitive workspace solution.
              </p>
        ...
        <div className="text-center mt-16">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            <div className="space-y-2">
              ...
              <h3 className="font-semibold">Free Team Access</h3>
              <p className="text-sm text-muted-foreground">
                14 days for your entire team, no credit card required
              </p>
            </div>
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground">
                Enterprise-grade security for all your team's work
              </p>
            </div>
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground">
                Get your team collaborating in minutes, not days
              </p>
            </div>
          </div>
        </div>
